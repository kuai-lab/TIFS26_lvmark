...
def get_video_dataloader(transforms, data_dir, img_size, batch_size=128, n_frames=16, num_imgs=None, shuffle=False, num_workers=4):
    """ Get dataloader for the videos in the data_dir."""
    dataset = VideoFolder_bcfhw(transforms, data_dir, img_size, n_frames=n_frames)    
